...
CREATE TABLE IF NOT EXISTS product_data(
  id serial,
  bottle_num VARCHAR(16),
  formula_name VARCHAR(64),
  is_remove BOOLEAN,
  kachi_result VARCHAR(16),
  is_ocr_equal_code BOOLEAN DEFAULT FALSE,
  qr_code VARCHAR(64),
  logistics VARCHAR(64),
  location_path VARCHAR(8),
  check_path VARCHAR(8),
  ocr_path VARCHAR(8),
  location_result VARCHAR(16),
  check_result VARCHAR(16),
  check_analysis VARCHAR(16),
  ocr_result VARCHAR(32),
  impurity_result VARCHAR(16),
  d0_impur_result VARCHAR(8),
  d1_impur_result VARCHAR(8),
  d2_impur_result VARCHAR(8),
  d0_max_time VARCHAR(16),
  d1_max_time VARCHAR(16),
  d2_max_time VARCHAR(16),
  d0_min_time VARCHAR(16),
  d1_min_time VARCHAR(16),
  d2_min_time VARCHAR(16),
  d0_start_time VARCHAR(32),
  d1_start_time VARCHAR(32),
  d2_start_time VARCHAR(32),
  d0_end_time VARCHAR(32),
  d1_end_time VARCHAR(32),
  d2_end_time VARCHAR(32),
